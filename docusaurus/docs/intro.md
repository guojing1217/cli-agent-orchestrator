...
A **profile** defines an agent's role, tools, and system prompt. Run `cao profile list` to see what's available. See the [Quick Start guide](/docs/getting-started/quick-start) for a full walkthrough.
