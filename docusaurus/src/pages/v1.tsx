...
const features = [
  ...
  },
  {
    ...
    emoji: '🔌',
    description:
      'Works with 9 providers including Claude Code, Kiro CLI, Codex, Copilot CLI, Cursor CLI, and more. Mix providers freely.',
...
export default function V1(): React.JSX.Element {
  return (
